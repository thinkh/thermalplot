...
module PVDVisualizations {
  ...
  export class PVDAHierarchyGrid implements PVDElementParent, IAnimateable {
    ...
    createNode(node:PVDModels.Node) {
    ...
    protected updateNodePosition(positions:D3.Map<PVDLayouts.PVDLayoutDimensions>):number[] {
      var that = this,
        wh = [0,0],
        runningTransitions = 0;

      function transition(node:PVDModels.Node, inlay) {
