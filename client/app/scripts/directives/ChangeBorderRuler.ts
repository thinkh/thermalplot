...
module PVDVisualizations {
  ...
  class ChangeBorderRuler {
    ...
    private attachListener():void {
      ...
      this.selection.on('infra'+id, (newInfra:PVDModels.Infrastructure) => {
  ...
  angular.module('pipesVsDamsApp').directive('pvdChangeBorderRuler',
    function (pvdWindowResize:PVDWindowResize, $timeout, pvdChangeBorder:PVDChangeBorder, pvdDataSelection: PVDDataSelection) {
    return  {
