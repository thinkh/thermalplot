...
module PVDVisualizations {
  ...
  export class DiagonalPVDLayoutEdge implements PVDLayoutEdge {
    ...
    constructor(public source:PVDLayouts.PVDLayoutDimensions = new PVDLayouts.PVDLayoutDimensions(), public target:PVDLayouts.PVDLayoutDimensions = new PVDLayouts.PVDLayoutDimensions(), public cssClass:string = '') {
    ...
    private anchorPoint(dim:PVDLayouts.PVDLayoutDimensions, horizontalAnchor:string, verticalAnchor:string):PVDPoint {
  ...
  export function edgeBetween(source:PVDLayouts.PVDLayoutDimensions, target:PVDLayouts.PVDLayoutDimensions, fqIname?:string) : PVDLayoutEdge{
  ...
  export class DendrogramPVDLayoutEdge implements PVDLayoutEdge {
    ...
    constructor(public source:PVDLayouts.PVDLayoutDimensions = new PVDLayouts.PVDLayoutDimensions(), public target:PVDLayouts.PVDLayoutDimensions = new PVDLayouts.PVDLayoutDimensions(), public cssClass:string = '', public shift:number[] = [0,0]) {
