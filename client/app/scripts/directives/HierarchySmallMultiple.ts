...
module PVDVisualizations {
  ...
  export class PVDHierarchySmallMultiple extends PVDAHierarchyGrid {
    ...
    constructor($root, private infra:PVDModels.Infrastructure, config: PVDHierarchyConfig) {
    ...
    private init(infra:PVDModels.Infrastructure):void {
      this.infra = infra;
      ...
      if(this.config.orientation === 'horizontal') {
        this.layouter = new PVDLayouts.PVDGridLayout();
      } else {
        this.layouter = new PVDLayouts.PVDVerticalGridLayout();
    ...
    relayout():void {
      if(this.config.orientation === 'horizontal') {
        ...
        var $overview = d3.select(this.$root[0][0].parentNode.parentNode),
            ...
            bundle:PVDLayouts.PVDLayoutBundle;
