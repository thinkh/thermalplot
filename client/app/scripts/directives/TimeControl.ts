...
module PVDTimeControl {
  ...
  function timeControl($svg:D3.Selection, pvdAnimator:PVDAnimator, pvdDataSelection:PVDDataSelection) {
    ...
    var id = '.time'+PVDVisualizations.nextID();
    ...
    PVDVisualizations.onDelete($svg, () => {
  ...
  angular.module('pipesVsDamsApp')
    .directive('pvdTimeControl', function ($timeout, pvdAnimator:PVDAnimator, pvdDataSelection:PVDDataSelection) {
