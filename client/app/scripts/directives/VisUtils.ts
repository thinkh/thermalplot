...
module PVDVisualizations {
   ...
   * @returns {*}
   */
  export function createNormalizer<T>(attr: PVDModels.IAttribute<T>, showFrequencies: boolean): INormalizer<T> {
   ...
   * @param elem
   */
  export function getBBox(elem: SVGLocatable);
  ...
  export function getBBox(elem: any) {
    ...
    return (<SVGLocatable>elem).getBBox();
  }
   ...
   * @param elem
   */
  export function getDimension(elem: SVGLocatable);
   ...
   */
  export function modifyConfig(config : PVDVisualizations.PVDHierarchyConfig, infra:PVDModels.Infrastructure, visConfigId:string = undefined, key:string = undefined) {
