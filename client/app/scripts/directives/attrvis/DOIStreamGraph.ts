...
module PVDVisualizations {
  export class PVDDOIStreamGraph extends PVDAAttributeVis {
    ...
    constructor($parent:D3.Selection, attr:PVDModels.DOIAttribute,
    ...
    private get doi() {
      return <PVDModels.DOIAttribute>this.attr;
    }
    ...
    private rebind(now:number, dt:number) {
      ...
      var pushData = (attr, i) => {
        ...
        var c = components[i];
        data.push({
          isConstant: attr instanceof PVDModels.ConstantAttribute,
          attr: attr.name,
