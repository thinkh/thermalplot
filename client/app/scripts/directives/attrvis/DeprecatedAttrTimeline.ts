...
module PVDVisualizations {
  ...
  export class PVDDeprecatedAttrTimeline<T> implements IAnimateable {
    private _attr:PVDModels.IAttribute<T>;
    ...
    constructor(attr:PVDModels.IAttribute<T>, showFrequencies:boolean, $parent:D3.Selection, private pvdDataSelection: PVDDataSelection, private step = createStepper(1000), public nMarkers = 20) {
    ...
    setAttribute(attr:PVDModels.IAttribute<T>, showFrequencies:boolean) {
      this._attr = attr;
  ...
  angular.module('pipesVsDamsApp').directive('pvdDeprecatedAttrTimeline', function (pvdAnimator:PVDAnimator, pvdDataSelection:PVDDataSelection, pvdInfrastructureLoader : PVDInfrastructureLoader, $timeout) {
      return  {
        ...
        controller: function ($scope) {
          $scope.id = PVDVisualizations.nextID();
        ...
        compile: function(element, attrs:any) {
          ...
          function findAttrs(infrastructure:PVDModels.Infrastructure, path: string) {
            var p = path.split("#"), attr = p[1], regex = new RegExp(p[0]);
            var nodes = infrastructure.nodes();
            var r = new Array<PVDModels.IAttribute<any>>();
          ...
          function createComposite(reduce: string, attrs: PVDModels.IAttribute<any>[]) {
            var r = new PVDModels.CompositeAttribute<any>();
