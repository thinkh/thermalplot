...
module PVDVisualizations {
  ...
  export class PVDGradientHeatmap extends PVDADataAttributeVis {
    ...
    constructor($parent:D3.Selection, attr:PVDModels.IAttribute<number>, normalizer:INormalizer<number>, config:PVDHierarchyConfig, parent:PVDElementParent, defConfig:any) {
    ...
    private convertToGradientData(data: any[]) {
      ...
      var r = [];
      data.forEach((v : PVDTimed.TimedValue<number>) => {
