...
class AChangeBorder {
  ...
  private _id = 'changeborder' + PVDVisualizations.nextID();
...
class PVDChangeBorder {
  ...
  crossed(node:PVDModels.Node, newSegRep:SegmentRepresentation, oldSegRep:SegmentRepresentation = null) {
...
angular.module('pipesVsDamsApp').service('pvdChangeBorder', PVDChangeBorder);
