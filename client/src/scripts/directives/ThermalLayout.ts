...
import { DOIFormula, computeWindow, computeTrajectory } from '../models/DOI';
...
export class PVDThermalLayout implements PVDElementParent, IAnimateable {
  ...
  private computeTrajectoriesActivities(node: Node, s: PVDSelection, f: DOIFormula) {
    return computeTrajectory(node, s, f).map((d) => [d.doi, d.delta]);
  }
...
export default angular.module('directives.pvdThermalLayout', [
